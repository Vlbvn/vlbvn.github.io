    ...
    >
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 pt-8 pb-4 md:pb-8 relative z-10">
        <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
          ...
          {/* Droite : Retour en haut */}
          <div className="text-center sm:text-right">
            <button
              onClick={scrollToTop}
              className="inline-flex items-center gap-2 text-xs font-mono text-slate-400 dark:text-slate-500 hover:text-teal-600 dark:hover:text-teal-400 transition-colors group cursor-pointer"
            >
              <span>Haut de page</span>
              <div className="p-1.5 bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-md group-hover:border-teal-500/20 dark:group-hover:border-teal-500/20 group-hover:-translate-y-0.5 transition-all duration-300 shadow-sm">
